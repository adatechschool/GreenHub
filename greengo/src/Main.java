...
public class Main {
    ...
    public static Trip trip22 = new Trip(toulouse,nantes,455, plane, 210,54);
    ...
    public static Travelers traveler1 = new Travelers("Nantais", nantes,4, 240, 500);
    public static Travelers traveler2 = new Travelers("Lyonnais",lyon,3, 240, 500);
    public static Travelers traveler3 = new Travelers("Parisiens",paris,4, 240, 500);
    public static Travelers traveler4 = new Travelers("Bordelais",bordeaux,2,240, 500);
    public static Travelers traveler5 = new Travelers("Toulousains",toulouse,3,240, 500);
